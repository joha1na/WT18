...
<head>
    ...
    */
   	 ...
   	 */
   	$dbh = new DB('_s0563285__mockupdatadb', 'db.f4.htw-berlin.de:3306', 's0563285', $password);
      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
             ...
             <button type="submit" class="btn btn-primary btn-black">Aktualisieren</button>
            </form>
                  ...
                  '<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                     <div class="thumbnail">
                        ...
                        <div class="buttons-edit">
                           ...
                           <a class="btn btn-default btn-sm"
                           href="'.htmlspecialchars($_SERVER["PHP_SELF"]).'?command=delete&id='.$teilnehmerin["id"].'">Delete</a>
                        </div>
                     </div>
                  </div>';
               }
